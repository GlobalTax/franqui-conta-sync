...
-- ============================================================================
-- INSTRUCCIONES: Ejecutar esta migración desde el dashboard de Supabase
-- SQL Editor > New Query > Copiar y ejecutar este código
-- ============================================================================
...
-- Verificación
SELECT 'Tabla pl_manual_adjustments creada correctamente ✓' as resultado;
