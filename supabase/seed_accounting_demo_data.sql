-- ============================================================================
-- Script de Datos de Prueba para Sistema Contable
-- ============================================================================
-- Este script crea asientos contables de prueba para el centro Abadiño (689)
-- para poder visualizar el Balance Sheet con datos realistas.
--
-- INSTRUCCIONES:
-- 1. Reemplazar {user_id} con un UUID de usuario válido de tu sistema
-- 2. Ejecutar en SQL Editor de Supabase
-- 3. Refrescar la página de Balance Sheet y seleccionar centro Abadiño
-- ============================================================================
...
BEGIN
  ...
  RAISE NOTICE 'Se crearon 10 asientos contables correctamente';
...
-- Resumen esperado:
-- Grupo 1 (Patrimonio Neto): -100,000.00 (Capital)
-- Grupo 2 (Activo No Corriente): 14,750.00 (Mobiliario 15,000 - Amort 250)
-- Grupo 3 (Existencias): -8,000.00 (Compras)
-- Grupo 4 (Acreedores): 18,150.00 (Clientes) 
-- Grupo 5 (Cuentas Financieras): 72,088.00 (Bancos + Caja)
-- Grupo 6 (Compras y Gastos): 28,850.00
-- Grupo 7 (Ventas e Ingresos): -35,000.00

-- Ecuación contable: Activo = Pasivo + Patrimonio Neto
-- Activo (2+3+4+5): 96,988
-- Pasivo + PN (1): 100,000
-- Resultado (6-7): -6,150 (pérdidas operativas del mes)
-- Total: 96,988 - 6,150 = 90,838 (esto se ajustaría con más operaciones)
