-- ============================================================================
-- Script de Datos de Prueba para Sistema Contable - ISLAZUL (1050)
-- ============================================================================
...
DECLARE
  ...
  v_centro_code TEXT := '1050'; -- Islazul
...
BEGIN
  ...
  RAISE NOTICE 'Se crearon 10 asientos contables correctamente para Islazul (1050)';
...
FROM calculate_balance_sheet('1050', '2025-01-31')
ORDER BY grupo;
