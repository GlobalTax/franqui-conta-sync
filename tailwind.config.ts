  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        ...
        heading: ['GeneralSans', 'system-ui', '-apple-system', 'sans-serif'],
        body: ['GeneralSans', 'system-ui', '-apple-system', 'sans-serif'],
      },
      colors: {
      ...
      animation: {
        ...
        "bounce-in-down": "bounce-in-down 0.6s cubic-bezier(0.34, 1.56, 0.64, 1)",
      },
    },
  },
